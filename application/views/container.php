...
<div class="wrapper">
	...
	<!-- Logo -->
	<a href="<?php echo SITEURL; ?>/assets/index2.html" class="logo">
		<!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini">SMTI-PUT</span>
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview">
				...
				<li><a href="<?php echo SITEURL; ?>/upload/payslips"><i class="fa fa-circle-o"></i> Upload Payslips</a></li>
				<li><a href="<?php echo SITEURL; ?>/upload/reference"><i class="fa fa-circle-o"></i> Upload Reference File</a></li>
				</ul>
			</li>
